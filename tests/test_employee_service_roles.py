...
class TestEmployeeServiceRoleBasedAccess:
    ...
    def test_list_employees_admin_sees_all(self, mock_require_permission,
                                           employee_service, mock_repository,
                                           admin_user):
    ...
    @patch('services.employee.require_permission')
    def test_list_employees_management_sees_all(self, mock_require_permission,
                                                employee_service, mock_repository,
                                                management_user):
    ...
    @patch('services.employee.require_permission')
    def test_list_employees_sales_sees_sales_and_management(self,
    ...
    @patch('services.employee.require_permission')
    def test_list_employees_support_sees_support_and_management(self,
                                                                mock_require_permission,
                                                                employee_service,
                                                                mock_repository,
                                                                support_user):
    ...
    @patch('services.employee.require_permission')
    def test_list_employees_unknown_role_returns_empty(self,
                                                       mock_require_permission,
                                                       employee_service,
                                                       mock_repository):
