"""
Configuration des fixtures pour tests unitaires
Tests isolés avec mocks, sans base de données réelle
"""
import pytest
...
@pytest.fixture
def mock_session():
    """Session de base de données mockée pour tests unitaires"""
    session = MagicMock()
...
@pytest.fixture
def mock_roles():
    """Rôles mockés pour tests unitaires"""
