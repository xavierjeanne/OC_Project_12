...
from models import Customer, Event, Contract, Employee, Role
...
class TestCLIServiceFactories:
    ...
    def test_get_customer_service(self):
        ...
        with patch('cli.commands.customer.Session') as mock_session_class, \
             patch('cli.commands.customer.CustomerRepository') as mock_repo_class, \
             patch('cli.commands.customer.CustomerService') as mock_service_class:
    ...
    def test_get_event_service(self):
        ...
        with patch('cli.commands.event.Session') as mock_session_class, \
             patch('cli.commands.event.EventRepository') as mock_repo_class, \
             patch('cli.commands.event.EventService') as mock_service_class:
    ...
    def test_get_contract_service(self):
        ...
        with patch('cli.commands.contract.Session') as mock_session_class, \
             patch('cli.commands.contract.ContractRepository') as mock_repo_class, \
             patch('cli.commands.contract.ContractService') as mock_service_class:
    ...
    def test_get_employee_service(self):
        ...
        with patch('cli.commands.employee.Session') as mock_session_class, \
             patch('cli.commands.employee.EmployeeRepository') as mock_repo_class, \
             patch('cli.commands.employee.EmployeeService') as mock_service_class:
    ...
    def test_all_service_factories_return_valid_objects(self):
        ...
        with patch('cli.commands.customer.Session'), \
        ...
        with patch('cli.commands.event.Session'), \
        ...
        with patch('cli.commands.contract.Session'), \
        ...
        with patch('cli.commands.employee.Session'), \
...
class TestCLIUtilities:
    ...
    def test_session_cleanup(self, mock_session_class):
        ...
        with patch('cli.commands.customer.CustomerRepository'), \
             patch('cli.commands.customer.CustomerService'):
...
class TestCLIErrorHandling:
    ...
    def test_validation_error_propagation(self):
        ...
        with patch('cli.commands.customer.Session') as mock_session_class, \
            ...
            mock_service = Mock()
            mock_service.create_customer.side_effect = ValidationError("Invalid email format")
            mock_service_class.return_value = mock_service
    ...
    def test_general_exception_handling(self):
        ...
        with patch('cli.commands.event.Session') as mock_session_class, \
            ...
            mock_service = Mock()
            mock_service.list_events.side_effect = Exception("Database connection failed")
            mock_service_class.return_value = mock_service
    ...
    def test_customer_service_integration(self):
        ...
        with patch('cli.commands.customer.Session') as mock_session_class:
            ...
            with patch('cli.commands.customer.CustomerRepository') as mock_repo_class:
                ...
                with patch('cli.commands.customer.CustomerService') as mock_service_class:
                    mock_service = Mock()
                    mock_service_class.return_value = mock_service
