...
from utils.validators import (
    ValidationError, validate_email, validate_phone, 
    validate_positive_amount, validate_non_negative_amount,
    validate_remaining_amount, validate_date_order, validate_password,
    validate_positive_integer, validate_role, validate_string_not_empty
)
...
class TestValidators:
    ...
    def test_validate_phone_success(self):
        ...
        assert validate_phone("  01 23 45 67 89  ") == "01 23 45 67 89"  # Garde les espaces
    ...
    def test_validate_string_not_empty_errors(self):
        ...
        with pytest.raises(ValidationError):
            validate_string_not_empty("   ")  # Seulement espaces