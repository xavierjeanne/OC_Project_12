...
class TestCustomerServiceRoleBasedAccess:
    ...
    def test_list_customers_admin_sees_all(
        self, mock_require_permission, customer_service, mock_repository, admin_user
    ):
    ...
    @patch("services.customer.require_permission")
    def test_list_customers_management_sees_all(
        self,
    ...
    @patch("services.customer.require_permission")
    def test_list_customers_support_sees_all(
        self, mock_require_permission, customer_service, mock_repository, support_user
    ):
    ...
    @patch("services.customer.require_permission")
    def test_list_customers_sales_sees_all_customers(
        self, mock_require_permission, customer_service, mock_repository, sales_user
    ):
    ...
    @patch("services.customer.require_permission")
    def test_list_customers_unknown_role_sees_all_customers(
        self, mock_require_permission, customer_service, mock_repository
    ):
    ...
    @patch("services.customer.require_permission")
    def test_list_customers_permission_denied_raises_error(
        self, mock_require_permission, customer_service, mock_repository, sales_user
    ):
