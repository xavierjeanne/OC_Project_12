...
class TestAuthenticationManager:
    ...
    def test_logout_not_logged_in(self, auth_manager):
        ...
        assert (
            ...
            or "logged out" in result["message"].lower()
        )
    ...
    def test_get_current_user_from_token(
        self, auth_manager, sample_employee_data, sample_tokens
    ):
    ...
    def test_get_current_user_token_refresh(self, auth_manager, sample_tokens):
        ...
        auth_manager.jwt_service.verify_token = MagicMock(
            side_effect=[None, token_payload]
        )
    ...
    def test_require_permission_success(
        self, mock_session_class, auth_manager, sample_employee_data
    ):
