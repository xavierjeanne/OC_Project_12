...
class TestPermissions:
    ...
    def test_has_permission_with_valid_employee(self, permissions_roles, auth_service_permissions, permissions_repos):
        ...
        sales_data = auth_service_permissions.create_employee_with_password(
            ...
            role_id=permissions_roles["sales"].id, password="TestPass123!"
        )
    ...
    def test_require_permission_success(self, permissions_roles, auth_service_permissions, permissions_repos):
        ...
        mgmt_data = auth_service_permissions.create_employee_with_password(
            ...
            role_id=permissions_roles["management"].id, password="TestPass123!"
        )
    ...
    def test_require_permission_failure_insufficient_permission(self, permissions_roles, auth_service_permissions, permissions_repos):
        ...
        support_data = auth_service_permissions.create_employee_with_password(
            ...
            role_id=permissions_roles["support"].id, password="TestPass123!"
        )
    ...
    def test_can_update_own_assigned_customer_success(self, permissions_roles, auth_service_permissions, permissions_repos):
    ...
    def test_can_update_own_assigned_customer_failure(self, permissions_roles, auth_service_permissions, permissions_repos):
    ...
    def test_can_update_own_assigned_customer_management(self, permissions_roles, auth_service_permissions, permissions_repos):
    ...
    def test_describe_permissions(self):
        ...
        assert "No permissions" in invalid_desc or "Unknown role" in invalid_desc or "Invalid role" in invalid_desc

    def test_can_update_own_assigned_contract(self, permissions_roles, auth_service_permissions, permissions_repos):
    ...
    def test_can_update_own_assigned_event(self, permissions_roles, auth_service_permissions, permissions_repos):
